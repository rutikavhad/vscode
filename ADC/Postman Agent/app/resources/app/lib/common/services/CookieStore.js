...
const { Store, Cookie, pathMatch, permuteDomain } = require('@postman/tough-cookie'),
...
class CookieStore extends Store {
   ...
   * @param {String} domain - The domain of the cookie
   * @param {String} path - The path of the cookie
   * @param {Boolean} [allowSpecialUseDomain] - If true, the special use domain '.' will be matched
   * @param {Function} cb - Callback function
   */
  findCookies (domain, path, allowSpecialUseDomain, cb) {
    ...
    let pathMatcher,
      results = [],
      domains = permuteDomain(domain, allowSpecialUseDomain) || [domain];
